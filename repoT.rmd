...
```
  ...
  <b>Se buscaron variables relacionadas con la economía:</b>
  <br>
  <li>Popularidad de la palabra "carro" según Google Trends.
  <li>Tasa representativa del mercado(dólar).
  
  <li><a href="https://www.dane.gov.co/index.php/estadisticas-por-tema/mercado-laboral/empleo-y-desempleo%22%3E"> Tasa de empleo</a>
  
  <li><a href="https://www.dane.gov.co/index.php/estadisticas-por-tema/mercado-laboral/empleo-y-desempleo%22%3E"> Tasa de desempleo</a>
  
  <li><a href = "http://www.banrep.gov.co/es/indice-precios-consumidor-ipc%22%3E"> Índice de precio al consumidor</a>
  
  <li><a href = "https://es.wikipedia.org/wiki/Petr%C3%B3leo_Brent%22%3E"> Precio promedio de el barril de petróleo BRENT</a>
  <li><a href = "http://www.salariominimocolombia.net/historico/%22%3E"> Salario mínimo</a>
  
  <li><a href =  "https://www.eltiempo.com/archivo/documento/MAM-541703%22%3E"> DTF</a>
  
  <li><a href = "https://www.fedesarrollo.org.co/encuestas/consumidor-eoc%22%3E"> Índice de confianza del consumidor</a>
...
Se obtuvo un $R^2$ de 66% aproximadamente, al aplicar selección de variable hacia atrás se obtuvo este otro modelo:
...
A partir de esto se decide probar con otro modelo, se procede a hacer uso de la regresión Poisson a partir de la función "glm" de R con todas las variables:
...
Ahora hay otro problema para abarcar: ¿Son las variables a usar realmente proyectables? ¿Qué tan confiables son estas proyecciones, si es que existen? 
...
Se decide entonces a probar con un modelo de regresión Poisson solamente con las variables sin necesidad de proyección:
```{r}
summary(mod_pois_glm)
1-(mod_pois_glm$deviance/mod_pois_glm$null.deviance)
```

Cómo se puede ver, nuestro $R^2$ se conservó de una manera impresionante, dando a entender que las variables que más influyen en nuestro modelo son las que carecen de la necesidad de proyección, tener un modelo así posee muchas ventajas, una de ellas es que se puede proyectar con mayor facilidad y sin restricciones a futuro -eso si- se debe tener en cuenta que el entrenamiento de los datos sólo tuvo en cuenta lo comprendido entre 2012 y 2016 y que esas tendencias pueden desaparecer a medida que el tiempo pase.
